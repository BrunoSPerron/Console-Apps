...
namespace Game
{
    public class ExtendedConsole
    {
        ...
        public static void VirtualLayerReset(int _layerIndex = -1)
        {
            ...
            Layers[index] = new CHAR_INFO[Console.BufferWidth^+ 1, Console.WindowHeight + 1];
        }
        ...
        public static int ShowMenuAndGetChoice(string[] _options, int x = 0, int y = 0, int _startingPosition = 0, bool _canCancel = true, bool[] _disabledOptions = null, bool withBox = true)
        {
            int width = 0;
            ...
            if (_startingPosition < 0 || _startingPosition >= _options.Length)
                _startingPosition = 0;
            ...
            int choice = _startingPosition + 1;
